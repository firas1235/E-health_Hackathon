            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <br>
                        <li><a href="users.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-ok"></span><p>Current Users</p></a></li>
...
<html>
    <head>
        ...
        <h2><center>Inscription Confirmée</center><h2>
                    </div><!-- Row -->
                </div><!-- Main Wrapper -->
